...
public class WhenAnyScheduledStateExecutorTest {

    @Test
    public void getTasksTest() {
        Collection<Task<String>> tasks = new LinkedList<>();
        WhenAnyScheduledStateExecutor<String> executor = new WhenAnyScheduledStateExecutor<>(null, null, tasks);
    ...
    public void constructorTest() {
        ...
        WhenAnyScheduledStateExecutor<String> executor = new WhenAnyScheduledStateExecutor<>(canceledStateExecutor, runningStateExecutor, tasks);
    ...
    public void executeTest() throws Exception {
        ...
        IStateExecutor canceledStateExecutor = new StateExecutor(State.CANCELED);
        IStateExecutor runningStateExecutor = new StateExecutor(State.RUNNING);
        WhenAnyScheduledStateExecutor<?> executor = new WhenAnyScheduledStateExecutor<>(canceledStateExecutor, runningStateExecutor, tasks);
        ...
        assertFalse(taskB.getFinishedEvent().hasFired());
    }
