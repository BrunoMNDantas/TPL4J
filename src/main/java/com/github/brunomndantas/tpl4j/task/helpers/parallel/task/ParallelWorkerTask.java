...
public class ParallelWorkerTask<T,K> extends Task<Collection<K>> {
    ...
    public ParallelWorkerTask(String taskId, IParallelAction<T,K> action, Iterator<T> iterator, ICancellationToken cancellationToken, Consumer<Runnable> scheduler, Option... options) {
